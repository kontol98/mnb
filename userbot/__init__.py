...
# Default .pms
PMPERMIT_PIC = os.environ.get("PMPERMIT_PIC") or None
...
UPSTREAM_REPO_URL = (os.environ.get("UPSTREAM_REPO_URL")
                     or "https://github.com/agupipi768/OneChanUboy-Remix")
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply(
                    "I'm [OneChan-UserBot](https://Nekopoi.care) modules helper...\nplease make your own bot, don't use mine 😋"
                )
            else:
            ...
            if event.query.user_id == uid and query.startswith(""):
                ...
                result = builder.article(
                    ...
                    text="{}\nTotal loaded modules: {}".format(
                        "[OneChan-UserBot](https://Nekopoi.care) modules helper.\n",
                        len(dugmeler),
                    ),
                    buttons=buttons,
                    link_preview=False,
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # pylint:disable=E0602
                ...
                reply_pop_up_alert = "Anjer Pencet pencet Bot orang, dih Kepo"
                await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
